...
<body class="hold-transition login-page">
	...
	<div class="login-box">
		...
		<div class="login-box-body">
			<p class="login-box-msg">Masuk sebagai Admin Jual</p>
			...
			<a href="<?= base_url('dashboard/daftar') ?>" class="text-center">Register admin jual</a><br>
			<a href="<?= base_url('dashboard/admin') ?>">Super Admin</a>
